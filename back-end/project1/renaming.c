...
// compare 2 strings 
int strcmp_RENAME( const char *a, const char *b) 
{
...
void scanident() 
{
  ...
  { 
    if (strcmp_RENAME( reswrd[ i][ 0], idbuff) == 0) 
    {
      isResWrd = true;
